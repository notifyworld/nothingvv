...
export const WorkspaceDashboard = ({
  ...
  const handleExportCode = async () => {
    ...
    try {
      ...
      a.href = url;
      a.download = `soul-project-${containerId.slice(0, 8)}.zip`;
  ...
  const WelcomeMessage = () => (
    <div className="flex flex-col items-start mb-4">
      <div className="flex items-center gap-2 mb-2">
        ...
        />
        <span className="text-sm font-medium text-white/90">Soul Assistant</span>
      </div>
      <div className="rounded-xl px-4 py-3 text-sm leading-relaxed bg-gray-700/60 backdrop-blur-md border border-gray-600/40 text-gray-100 w-full shadow-sm relative">
        ...
        <div className="relative z-10">
          <div className="prose prose-sm prose-invert max-w-none [&_h2]:text-white [&_h3]:text-white [&_h4]:text-white [&_strong]:text-white">
            <p className="mb-2">
              👋 Welcome to your Soul project! I'm here to help you build,
              modify, and deploy your application across multiple frameworks.
            </p>
          ...
          <div className="flex items-center gap-3 relative z-10">
            ...
            >
              ...
              <div className="hidden sm:flex flex-col">
                ...
                <span className="text-xs text-white/50">Soul Project</span>
              </div>
              {sidebarOpen ? (
                  ...
                  {isLoading && !streamingMessageId && (
                    <div className="flex items-start">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <span className="text-sm font-medium">Soul Assistant</span>
                      </div>
